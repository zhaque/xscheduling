...
urlpatterns = patterns('',
    ...
    url(r'^contact/(?P<object_id>\d+)/$', 'client.views.get_contact', name='client-contact-view'),
    url(r'^contact/(?P<object_id>\d+)/edit/$', 'client.views.edit_contact', name='client-contact-edit'),
    url(r'^(?P<object_id>\d+)/note/add/$', 'client.views.add_note', name='client-note-add'),
    url(r'^note/(?P<object_id>\d+)/$', 'client.views.get_note', name='client-note-view'),
    url(r'^note/(?P<object_id>\d+)/edit/$', 'client.views.edit_note', name='client-note-edit'),
)
