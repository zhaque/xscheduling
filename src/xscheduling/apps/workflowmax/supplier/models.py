...
class Supplier(object):
  ...
  delete_url = "http://api.workflowmax.com/supplier.api/delete?apiKey=%s&accountKey=%s" % (settings.WORKFLOWMAX_APIKEY, settings.WORKFLOWMAX_ACCOUNTKEY)
